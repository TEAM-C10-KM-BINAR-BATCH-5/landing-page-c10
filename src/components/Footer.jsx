    ...
    <div className="w-full bg-white py-24 px-5">
      <div className="md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0">
        <div className="col-span-2">
          <h1 className="text-2xl font-extrabold text-costumeBlue">LEARNHUB</h1>
          ...
          <div className="flex gap-4 py-4">
            <div className="p-4 bg-[#E9F8F3] rounded-xl">
              <FaFacebookF
                size={25}
                style={{ color: "rgba(97, 72, 255, 1)" }}
              />
            </div>
            <div className="p-4 bg-[#E9F8F3] rounded-xl">
              <FaDribbble size={25} style={{ color: "rgba(97, 72, 255, 1)" }} />
            </div>
            <div className="p-4 bg-[#E9F8F3] rounded-xl">
              <FaLinkedinIn
                size={25}
            ...
            <div className="p-4 bg-[#E9F8F3] rounded-xl">
              <FaBehance size={25} style={{ color: "rgba(97, 72, 255, 1)" }} />
            </div>
          </div>
        </div>
        ...
        <div className="max-[780px]:col-span-2">
          ...
          <form className="py-4">
            ...
            />
            <button className="max-[780px]:w-full my-4 px-5 py-3 rounded-md bg-costumeBlue text-white font-medium">
              Subscribe Now
            </button>
          </form>
        </div>
